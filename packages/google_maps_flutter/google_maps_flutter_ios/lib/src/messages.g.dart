...
class MapsInspectorApi {
  ...
  Future<PlatformCameraPosition> getCameraPosition() async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.google_maps_flutter_ios.MapsInspectorApi.getCameraPosition$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as PlatformCameraPosition?)!;
    }
  }
}
